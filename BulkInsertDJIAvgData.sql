...
--TRUNCATE TABLE [dbo].[DJI_Avge_HistData]
--GO
...
DECLARE
    ...
    @value_chr        VARCHAR(255)  = 'C:\Finance\StageStockHistoryData\DJI2023-2025\',
...
-- Use a file cursor to load the flat files into [dbo].[DJI_Avge_HistData]
...
BEGIN
	SET @sql = 'BULK INSERT  [dbo].[DJI_Avge_HistData] ' +  
...
SELECT MAX(TradeDate), MIN(TradeDate)   FROM [dbo].[DJI_Avge_HistData];
